...
if (isalpha (p1))
    if (islower (p1))
       /* La función islower regresa 1 si p1 es una letra minúscula 
       y 0 en caso contrario.
       La función isupper, por otra parte, regresa 1 si p1 es una 
       letra mayúscula y 0 en caso contrario. */
...
printf("%c fue convertida de mayúscula a minúscula \n",tolower(p1)); 
         /* La función tolower convierte de mayúscula a minúscula. 
         Si la letra es minúscula no la modifica. La función 
         toupper, por otra parte, convierte de minúscula a 
         mayúscula. Si la letra es mayúscula no la modifica. */
    else
       printf("%c es una letra minúscula \n", p1);
else
    printf("%c no es una letra \n", p1);
