...
struct alumno
{
   ...
   char carrera[20];
   float promedio;
   char direccion[20];        /* Declaración de la estructura. */
...
printf("Ingrese la carrera del alumno3 :");
strcpy(a3.carrera, car);
printf("Ingrese el promedio del alumno3: ");
scanf("%f", &pro); 
a3.promedio = pro; 
fflush(stdin); 
...
/* Observa otra forma de escribir los compos de la variable de tipo estructura a3. */
