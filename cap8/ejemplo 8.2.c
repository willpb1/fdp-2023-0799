...
En la lectura de los campos de ➥formatos.
...
En la lectura de los campos de las variables a4 se utilizan como ejemplo ambos formatos. */
...
printf("\nDatos del alumno 3\n");
/* Observa la forma de escribir los campos de los apuntadores de tipo de estuctura */
...
printf("\nDatos del alumno 6\n");
/* Observa la forma de escribir los campos de la variable tipo estructura. */ printf("%d\t%s\t%s\t%.2f\t%s", a6.matricula, a6.nombre, a6.carrera,
